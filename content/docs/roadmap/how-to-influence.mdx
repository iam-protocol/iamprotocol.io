...
What does not change the roadmap, on its own:

- Trend speculation
- Marketing requests
- Single-integrator preferences without production usage behind them
