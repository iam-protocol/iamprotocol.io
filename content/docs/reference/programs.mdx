...
| `update_anchor` | Re-verification path. Validates a fresh proof against the current commitment, advances the score, rotates the previous commitment. |
| `reset_identity_state` | Recovery path. Zeroes the score and clears the fingerprint commitments after a 7-day cooldown. Charges the fee. |
